...
let names: string[] = ["Andreas", "Sammy", "Dennis", "Inessa", "Rosa", "Elvira", "Erwin", "Julia", "Jason", "Matthias", "Maria", "Jenny"];
...
let picture: number = 1
function gifthegif(): void {
    console.log("yesyes")
...
function buttonClicked(_event: Event): void {
    ...
    let chosenname: string = names[index]
    names.splice(index, 1);

    const img: HTMLImageElement = <HTMLImageElement>document.getElementById("wichtelbild");
    switch (chosenname) {
        case "Dennis":
